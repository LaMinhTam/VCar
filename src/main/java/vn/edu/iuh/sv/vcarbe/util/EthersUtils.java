...
public class EthersUtils {
    ...
    public static void verifyMessage(DigitalSignature digitalSignature) {
        if(!digitalSignature.address().equals(EthersUtils.addressFromMessageAndSignature(digitalSignature.message(), digitalSignature.signature()))){
            throw new AppException(400, "Invalid signature");
        }
    }

    public static String addressFromMessageAndSignature(String message, String signature) {
