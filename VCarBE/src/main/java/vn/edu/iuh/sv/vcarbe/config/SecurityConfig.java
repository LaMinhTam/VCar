...
import vn.edu.iuh.sv.vcarbe.security.oauth2.CustomOAuth2UserService;
import vn.edu.iuh.sv.vcarbe.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import vn.edu.iuh.sv.vcarbe.security.oauth2.OAuth2AuthenticationFailureHandler;
import vn.edu.iuh.sv.vcarbe.security.oauth2.OAuth2AuthenticationSuccessHandler;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/signup", "/auth/login", "/auth/signin", "/auth/verify","/oauth2/**")
                        .permitAll()
                        .anyRequest()
                        .authenticated())
